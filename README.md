...
FIRST OF ALL: This is not mine original project, thats a project from user: flyapen, thank you for provide that piece of code.

The code was outadetd, so I make some modifications, that continue to improve and resolve some issues with some plugins and packages.
